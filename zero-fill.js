...
console.log(zeroFill(11, 5)) // => It should return "00011"
console.log(zeroFill(11, 11)) // => It should return "00000000011"
console.log(zeroFill(-32, 5)) // => It should return "00032"
console.log(zeroFill(0, 3)) // => It should return "000"
