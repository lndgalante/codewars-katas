...
do
    case $opt in
        "1 Kyu")
            mkdir 1-kyu/"$KATA"
            cp boilerplate.js 1-kyu/"$KATA"/index.js
            cp boilerplate.test.js 1-kyu/"$KATA"/index.test.js
            break
            ;;
        "2 Kyu")
            mkdir 2-kyu/"$KATA"
            cp boilerplate.js 2-kyu/"$KATA"/index.js
            cp boilerplate.test.js 2-kyu/"$KATA"/index.test.js
            break
            ;;
        "3 Kyu")
            mkdir 3-kyu/"$KATA"
            cp boilerplate.js 3-kyu/"$KATA"/index.js
            cp boilerplate.test.js 3-kyu/"$KATA"/index.test.js
            break
            ;;
        "4 Kyu")
            mkdir 4-kyu/"$KATA"
            cp boilerplate.js 4-kyu/"$KATA"/index.js
            cp boilerplate.test.js 4-kyu/"$KATA"/index.test.js
            break
            ;;
        "5 Kyu")
            mkdir 5-kyu/"$KATA"
